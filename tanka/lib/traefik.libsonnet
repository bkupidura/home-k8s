  ...
  traefik: {
    ...
    helm: $._custom.helm.new('traefik', 'https://helm.traefik.io/traefik', $._version.traefik.chart, 'traefik-system', {
      ...
      additionalArguments: [
        ...
        std.format('--entryPoints.web.forwardedHeaders.trustedIPs=%s', $._config.traefik.k8s_net),
        std.format('--entryPoints.websecure.forwardedHeaders.trustedIPs=%s', $._config.traefik.k8s_net),
        '--log',
        '--log.level=INFO',
